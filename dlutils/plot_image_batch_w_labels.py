...
def plot_batch(image_batch, figure_path, label_batch=None):
    ...
    # for gray images if image_batch.shape = (img_height, img_width, 1) plt requires this to be reshaped
    ...
    _, ax = plt.subplots(nb_rows, nb_columns, sharex=True, sharex=True)
